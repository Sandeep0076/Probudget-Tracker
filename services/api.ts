...
// Settings
export const getSettings = () => get<{ theme: string; customThemeColor: string }>(`/api/settings`);
export const setSettings = (theme: string, customThemeColor: string) => post<{ ok: boolean }>(`/api/settings`, { theme, customThemeColor });
