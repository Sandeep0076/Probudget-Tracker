...
const UniversalHeader: React.FC<UniversalHeaderProps> = ({ onNavigate, onAddTransactionClick }) => {
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-grow p-4 space-y-2">
            ...
            <a href="#" onClick={(e) => { e.preventDefault(); handleMobileNavClick('dashboard'); }} className="block px-4 py-3 rounded-md text-base font-medium text-text-secondary hover:bg-surface/70 hover:text-text-primary">Dashboard</a>
            <a href="#" onClick={(e) => { e.preventDefault(); handleMobileNavClick('budgets'); }} className="block px-4 py-3 rounded-md text-base font-medium text-text-secondary hover:bg-surface/70 hover:text-text-primary">Budgets</a>
            <a href="#" onClick={(e) => { e.preventDefault(); handleMobileNavClick('transactions'); }} className="block px-4 py-3 rounded-md text-base font-medium text-text-secondary hover:bg-surface/70 hover:text-text-primary">Transactions</a>
          </nav>
